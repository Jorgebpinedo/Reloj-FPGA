-- Dise�o del reloj global (fpga_reloj) integrando mediante una arquitectura beheavioral los componentes fsm, Visualizador, Sincronizador de entradas y las se�ales de reloj.
